...
export function Cart({ isOpen, onClose }: CartProps) {
  ...
  useEffect(() => {
    if (showPhoneVerification && verifyingPhone) {
      (async () => {
        const { verificationId: vId, error } = await signInWithPhone(verifyingPhone);
        if (!error && vId) {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const selectedState = statesList.find(s => s.name === deliveryDetails.state);
            ...
            <div className="flex flex-col items-center justify-center min-h-[300px] gap-6">
              <div className="bg-green-50 border border-green-200 rounded-xl p-6 max-w-lg w-full text-center shadow">
                ...
                <p className="text-base text-green-800 mb-4">
                  Thank you for your order. Our team will contact you soon regarding order and payment confirmation.<br />
                  <br />
                  Meanwhile, you can use any of our payment options below to complete your payment and send us the screenshot with your contact details, or you can contact us directly.
                </p>
                <div className="mb-4">
                  <a
                    href="/payment"
                ...
                <div className="text-sm text-gray-700">
                  ...
                  <div>📞 <a href="tel:+919876543210" className="underline">+91 98765 43210</a></div>
                  <div>📱 <a href="https://wa.me/919876543210" className="underline" target="_blank" rel="noopener noreferrer">WhatsApp</a></div>
                  <div>✉️ <a href="mailto:support@soundwavecrackers.com" className="underline">support@soundwavecrackers.com</a></div>
                </div>
              </div>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          value={stateOptions.find(opt => opt.value === deliveryDetails.state) || null}
                          onChange={option => handleDeliveryDetailsChange({
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          value={districtOptions.find(opt => opt.value === deliveryDetails.district) || null}
                          onChange={option => handleDeliveryDetailsChange({
                            target: { name: "district", value: option?.value || "" }
                          } as any)}
                          isClearable
