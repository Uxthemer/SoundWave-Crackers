      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-text/60 max-w-2xl mx-auto">
            ...
            We're here to help you make your celebration spectacular!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-montserrat font-bold text-lg mb-2">Visit Us</h3>
                <p className="text-text/60">
                  Sattur to Sivakasi Main Road<br />
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-montserrat font-bold text-lg mb-2">Email Us</h3>
                <p className="text-text/60">
                  info@soundwavecrackers.com<br />
        ...
        <div className="mt-12 rounded-lg overflow-hidden h-80">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.5965666493383!2d77.5945627!3d12.9715987!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae1670c9b44e6d%3A0xf8dfc3e8517e4fe0!2sBengaluru%2C%20Karnataka%2C%20India!5e0!3m2!1sen!2sin!4v1635835853001!5m2!1sen!2sin"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
