          ...
          <div className="container mx-auto flex items-center justify-between">
            <Link to="/" className="flex items-center space-x-2">
              <img
                ...
                className="hidden dark:block h-20 w-auto dark:invert -ml-3"
              />
              <img
                src="/assets/img/logo/logo_1.png"
                alt="SoundWave Crackers"
                className="block dark:hidden h-20 w-auto light:invert -ml-3"
              />
            </Link>

            {/* Menu items - Left aligned on mobile */}
            <div
              className={`md:flex items-center space-x-8 ${
                isMobileMenuOpen
                  ? "flex flex-col absolute top-full left-0 w-full bg-background p-4 space-y-4 md:space-y-0 md:relative md:w-auto md:p-0 md:bg-transparent"
                  : "hidden md:flex"
